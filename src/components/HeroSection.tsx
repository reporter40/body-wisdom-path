...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-end md:items-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative section-container py-12 pb-16 md:py-32">
        <div className="max-w-2xl">
          <h1 className="heading-primary animate-fade-up mb-4 md:mb-6">
            Возвращение к себе{" "}
            <span className="text-gradient">через тело</span>
          </h1>
          
          <p className="text-body-large mb-6 md:mb-8 animate-fade-up animation-delay-200 pr-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-fade-up animation-delay-400">
            <Button variant="cta" size="xl" onClick={scrollToForm} className="text-sm sm:text-base whitespace-normal h-auto py-3 px-4 sm:py-4 sm:px-6">
              Записаться на диагностическую сессию
            </Button>
          </div>

          {/* Trust indicators */}
          <div className="mt-8 md:mt-12 flex flex-wrap gap-4 md:gap-6 animate-fade-up animation-delay-600">
